package com.atex.mdcpdprojects.http;
...
public class SurfWebAppsIT {
    ...
    private void testWebapp(String contextPath) throws Exception
    {
        testWebApp(contextPath, "localhost", 8080, false, null);
    }

    protected void testWebApp(final String contextPath, final String host,
        final int port, final boolean optional, final String scanForThis)
        throws Exception
    {
